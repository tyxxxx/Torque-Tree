...
public:
   ...
   pair<int, int> findSplitPoint(PNG* im, int k);
   double findEntropy2(pair<int, int> ul1, pair<int, int>lr1, pair<int, int> ul2, pair<int, int>lr2, int k, stats* s);
   double findEntropy4(pair<int, int> ul1, pair<int, int>lr1, pair<int, int> ul2, pair<int, int>lr2,
	   pair<int, int> ul3, pair<int, int>lr3, pair<int, int> ul4, pair<int, int>lr4, int k, stats* s);
   void pruneHelper1(Node *node, double tol);
   bool pruneHelper2(Node* curr, Node* curr1, double tol);
   void render(Node *curr, PNG *png);
